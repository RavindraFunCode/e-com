                    ...
                    <div class="row" id="group-row-div">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder="Enter Unit Name" type="text" name="name" id="name" required value="<?php if(!empty($edit_item)){ echo $edit_item->name;} ?>"  />
...
<script>
    var custome_base_url = "<?php echo base_url('dashboard/catalogue/unit/');?>";
        ...
        $.ajax({
            ...
            success:function(responce)
            {
              ...
              }else if(responce.status==1)
              {
                ...
                <?php 
                    if(!empty($edit_item)){ 
                        echo "window.location.href ='".base_url('dashboard/catalogue/unit/all')."';";
                    } else{
