                    ...
                    <div class="row" id="group-row-div">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder="Enter Brand Name" type="text" name="name" id="name" required value="<?php if(!empty($edit_item)){ echo $edit_item->name;} ?>"  />
                        ...
                        <div class="col-2 ">
                            <div class="mb-3 <?php echo !empty($edit_item) && !empty($edit_item->image) ? '' : 'show_img' ?>">
                                ...
                                <img src="<?php echo !empty($edit_item) && !empty($edit_item->image) ? get_files($this->upload_brand, $edit_item->image): '' ?>" title="attach image" style="width: 50%;" id="load_img" class="form-control ">
                            </div>
                        </div>
...
<script>
    var custome_base_url = "<?php echo base_url('dashboard/catalogue/brand/');?>";
        ...
        $.ajax({
            ...
            success:function(responce)
            {
              ...
              }else if(responce.status==1)
              {
                ...
                <?php 
                    if(!empty($edit_item)){ 
                        echo "window.location.href ='".base_url('dashboard/catalogue/brand/all')."';";
                    } else{
