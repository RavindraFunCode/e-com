                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="<?php  echo base_url();  ?>assets/web/assets/images/logo_footer.png" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-right">
                        ...
                        <figure class="payment">
                            <img src="<?php  echo base_url();  ?>assets/web/assets/images/payment.png" alt="payment" width="159" height="25" />
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <!-- Plugin JS File -->
<!--     <script src="<?php //  echo base_url();  ?>assets/web/assets/vendor/jquery/jquery.min.js"></script> -->
     <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/jquery.plugin/jquery.plugin.min.js"></script>
     <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/swiper/swiper-bundle.min.js"></script>
      <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/jquery.countdown/jquery.countdown.min.js"></script>
    <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/sticky/sticky.js"></script>
    <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
     <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/floating-parallax/parallax.min.js"></script>
    <script src="<?php  echo base_url();  ?>assets/web/assets/vendor/zoom/jquery.zoom.js"></script>
    <script src="<?php  echo base_url();  ?>assets/web/assets/js/main.min.js"></script>
<script type="text/javascript">
   ...
   var cdata = "";
    function addtocart(id){
      ...
      $.ajax({
           url:"<?php echo base_url() ?>Cart/insertCart",
           type:"POST",
           data:{id:id},
           cache: false,
          dataType:'json',
    ...
    function getcart(){
        $.ajax({
            ...
            dataType:'json',
            success:function(succ){
               $('#cart-products').html(succ.cartdata);
               $('#total-price').html(succ.total_price);
               $(".cart-count").html(succ.cart_num);                 
            }
        });
    }
    ...
    $(document).on("click", '.update_cart_count', function(){
        var id = $(this).data('rowid');
        var qty = parseInt($(this).siblings('input').val());
        if($(this).data('qty-type')=="plus"){
            qty=qty+1;
        }else{
            if(qty<=1){
                if(confirm("Can not Decrease Quantity.., Do You want to remove this item from Cart...")){
                    remove_from_cart(id);
                    reload_this_page();
                }else{
                    return false;
        ...
        $.ajax({
            ...
            success:function(succ){
                if(succ.status){
                    $("#"+id).html(succ.sub_total);
                    $("#total-price").html(succ.total);
                    $("#sub_total").html(succ.subtotal);
                    getcart();
                }else{
                    alert(succ.message);                   
                }                
